...
from .endereço_diarista_service import listar_endereco_diarista
...
def calcular_indice_compatibilidade(diaria_id, diarista_id):
    ...
    distancia_diarista_diaria = calcular_distancia_diaria_diarista(diaria.cep, endereco_diarista.cep)
